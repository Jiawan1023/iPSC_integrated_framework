...
#SBATCH -o /data7/ipsc/16p12_1_del/str_calls/slurm/logs/2_out_%a.log # TODO: set slurm output file
#SBATCH -e /data7/ipsc/16p12_1_del/str_calls/slurm/logs/2_err_%a.log # TODO: set slurm input file
#SBATCH --exclude=durga,ramona,laila # TODO: set nodelist
#SBATCH --array 13
#SBATCH --dependency=afterany:1752952
...
LINE=$(sed -n "$SLURM_ARRAY_TASK_ID"p /data7/ipsc/16p12_1_del/str_calls/slurm/files/2_smap.txt)
...
outdir="/data7/ipsc/16p12_1_del/str_calls/data/dumpstr/${sample_id}"
mkdir -p $outdir
